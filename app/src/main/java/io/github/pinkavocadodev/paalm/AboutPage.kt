...
fun AboutPage(modifier: Modifier= Modifier){
    ...
    Column(
        ...
        Column(Modifier.padding(25.dp)) {
            Text("Che cos'è Posso andare al mare?", fontSize=25.sp, fontWeight = FontWeight(1000))
            Text("Paalm? è una web app che si pone lo scopo di rispondere in maniera coincisa e minimalista alla semplice domanda \"Si può andare al mare oggi?\".\n" +
                    ...
                    "\n" +
                    "Basta consultare servizi meteo di dubbia validità e basta interpretare noi stessi una miriade di dati confusi, insomma, Posso andare al mare o no?")
            HorizontalDivider(Modifier.padding(10.dp))
            Text("FAQ", fontSize = 20.sp, fontWeight = FontWeight(1000))
            ...
            Text("A: Il servizio \"Posso andare al mare?\" non raccoglie alcun dato personale, né usa tracker di attività online.")
            ...
            HorizontalDivider(Modifier.padding(10.dp))
            Text("Contatti", fontSize = 25.sp, fontWeight = FontWeight(1000))
            ...
            HorizontalDivider(Modifier.padding(10.dp))
            Text("© $date Andrea Di Stefano, tutti i diritti riservati.")
        }
    }
}